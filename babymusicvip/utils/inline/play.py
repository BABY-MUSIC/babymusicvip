...
import math
from babymusicvip.utils.formatters import time_to_seconds
...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    babymusicvip = math.floor(percentage)
    if 0 < babymusicvip <= 10:
        bar = "𖢵—————————"
    elif 10 < babymusicvip < 20:
        bar = "—𖢵————————"
    elif 20 <= babymusicvip < 30:
        bar = "——𖢵———————"
    elif 30 <= babymusicvip < 40:
        bar = "———𖢵——————"
    elif 40 <= babymusicvip < 50:
        bar = "————𖢵—————"
    elif 50 <= babymusicvip < 60:
        bar = "—————𖢵————"
    elif 60 <= babymusicvip < 70:
        bar = "——————𖢵———"
    elif 70 <= babymusicvip < 80:
        bar = "———————𖢵——"
    elif 80 <= babymusicvip < 95:
        bar = "————————𖢵—"
    else:
        bar = "—————————𖢵"
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"babymusicvipPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"babymusicvipPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
